...
if page == "📁 Data Setup":
    ...
    if st.button("Save Mappings"):
        ...
        if missing:
            ...
            st.markdown("<h6 style='color: #12123B;'>✅ All required columns mapped!  You can now switch to Home or Per-Product views. If you encounter an error on either of these pages please return here and ensure you selected the right variables.</h1>", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
                ...
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px; margin-bottom: 10px;">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">€{rev_test_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(rev_test_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Test Before: €{rev_test_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px;">
                        <h5 style="margin: 0; color: #414168;">Control After</h5>
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">€{rev_ctrl_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(rev_ctrl_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Control Before: €{rev_ctrl_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px; margin-bottom: 10px;">
                        <h5 style="margin: 0; color: #414168;">Test After</h5>
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">€{mar_test_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(mar_test_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Test Before: €{mar_test_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px;">
                        <h5 style="margin: 0; color: #414168;">Control After</h5>
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">€{mar_ctrl_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(mar_ctrl_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Control Before: €{mar_ctrl_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px; margin-bottom: 10px;">
                        <h5 style="margin: 0; color: #414168;">Test After</h5>
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">{qty_test_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(qty_test_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Test Before: {qty_test_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown(f"""
                    <div style="background-color:#F9F6F0; padding: 15px; border-radius: 0px;">
                        <h5 style="margin: 0; color: #414168;">Control After</h5>
                        <div style="display: flex; justify-content: space-between;">
                            <h3 style="margin: 0; color: #12123B;">{qty_ctrl_after:,.2f}</h3>
                            <p style="margin: 0; color: #414168;">% Change: {style_pct_change(qty_ctrl_pct)}</p>
                        </div>
                        <p style="margin: 0; color: #414168;">Control Before: {qty_ctrl_before:,.2f}</p>
                    </div>
                """, unsafe_allow_html=True)
    ...
    # Select Group 1 column(s) and filter values
    ...
    # Additional filters for Group 1 (if you want to add more columns)
    ...
    # Select Group 2 column(s) and filter values (optional)
    ...
    # Additional filters for Group 2 (if you want to add more columns)
    ...
    if missing_cols:
        ...
        # Filter subsets for Group 2 (only if group2_vals is selected)
        if group2_vals:
