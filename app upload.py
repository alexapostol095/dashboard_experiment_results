...
if page == "📁 Data Setup":
    ...
    if st.button("Save Mappings"):
        ...
        if missing:
            ...
            st.markdown("<h1 style='color: #12123B;'>✅ All required columns mapped!  You can now switch to Home or Per-Product views. If you encounter an error on either of these pages please return here and ensure you selected the right variables.</h1>", unsafe_allow_html=True)
