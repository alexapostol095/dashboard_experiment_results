...
if page == "📁 Data Setup":
    ...
    st.markdown(
        ...
        <ul style='color: #414168;'>
            <li><b>StrategyBoxName/Sensitivity</b> and <b>PriceChange</b>
                <ul>
                    <li>Supplied in the table. StrategyBoxName may instead be sensitivity. If Price change does not exist, leave it blank. </li>
                </ul>
            </li>
    ...
    if st.button("Save Mappings"):
        ...
        if missing:
            ...
            st.success("✅ All required columns mapped!  You can now switch to Home or Per-Product views.")
